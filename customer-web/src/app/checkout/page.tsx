...
export default function CheckoutPage() {
  ...
  if (!authReady) {
    return (
      <section className="relative z-[1] mx-auto flex max-w-lg min-h-[40vh] flex-col items-center justify-center gap-3 px-5 pb-12 pt-8 text-center">
        ...
        <p className="text-xs text-slate-400 dark:text-slate-500">Loading checkout…</p>
      </section>
    );
  }
  ...
  return (
    <section className="relative z-[1] mx-auto w-full max-w-5xl space-y-4 overflow-x-hidden px-5 pb-28 pt-2 sm:space-y-6 sm:pb-12 md:pb-12">
      ...
      {user ? <CheckoutAddressSection sectionId="checkout-delivery" /> : null}
