...
export function DashboardPageFeature() {
  ...
  return (
    <section className="space-y-6">
      ...
      <RequestState error={error} loading={loading} loadingMessage="Loading dashboard..." />
      ...
      <div className="rounded-2xl bg-white p-4 shadow">
        ...
        <div className="space-y-2">
          {(data?.topSellingItems ?? []).length === 0 ? <p className="text-sm text-slate-500">No top-selling data yet.</p> : null}
